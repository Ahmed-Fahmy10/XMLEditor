...
public:
	...
	afx_msg void OnEditFixup();
	afx_msg void OnEditMinify();
	afx_msg void OnEditJson();
	afx_msg void OnUpdateEditJson(CCmdUI* pCmdUI);
	afx_msg void OnUpdateEditFixup(CCmdUI* pCmdUI);
	afx_msg void OnUpdateEditMinify(CCmdUI* pCmdUI);
};
